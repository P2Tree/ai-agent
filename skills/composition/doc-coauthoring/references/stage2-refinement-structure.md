...
- Use `create_file` to create an artifact
- Create artifact with all section headers and brief placeholder text like "[To be written]" or "[Content here]"
- Provide the scaffold link and indicate it's time to fill in each section

**If no access to artifacts:**
- Create a markdown file in the working directory (e.g., `decision-doc.md`, `technical-spec.md`)
...
**If using a file (no artifacts):** After drafting, confirm completion. Inform them the [SECTION NAME] section has been drafted in [filename].
